...
def read_data(self):
        changes_file = 'changes_python.txt' #create alias for file name
...
class Commit(object): #create a class for commits
    ...
    def read_data(self):
        changes_file = 'changes_python.txt' #create alias for file name
        self.data = [line.strip() for line in open(changes_file, 'r')] # import the information from changes_file, strip the white space and store each line as an object in a list
        return data
    ...
    def commits_per_author(self, commits):
    ...
    def fies_per_author(self, commits):
    ...
    def AMD_per_author(self, commits):        
        ...
        return numberA, numberM, numberD

    def daysByAuthor(self, commits):
    ...
    def dayOfTheWeek_per_author(self, commits):
